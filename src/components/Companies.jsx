    ...
    <div className='w-full bg-white py-[50px]'>
        <div className='md:max-w-[1480px] m-auto max-w-[600px]  px-4 md:px-0'>
            <div className='flex justify-center py-8 md:gap-8 '>
                <div className='grid md:grid-cols-5 grid-cols-2 gap-40'>
                  ...
                  <img src="https://ik.imagekit.io/irfantonov111/Unilever%20logo.png?updatedAt=1700466528356" alt="unilever logo" />
