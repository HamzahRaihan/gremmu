      ...
      <div className="flex flex-col w-full items-start gap-[20px] px-[32px] py-0 relative flex-[0_0_auto]">
        <div className="grid grid-cols-3 max-[980px]:grid-cols-2 m-auto justify-between gap-5 py-5 max-w-4xl relative self-stretch w-full flex-[0_0_auto]">
          <div className="flex flex-col items-start relative gap-3">
            <div className="relative bg-[#ffffff] rounded-[8px] ">
              <div className="flex-col items-center gap-[10px] relative top-[-5px] cursor-pointer">
                <img className="relative" alt="Greenworldaware" src="https://ik.imagekit.io/alzirahmana/Asset%20-%20mobile%20responsive%20web/GreenWorldAware-2%201.png?updatedAt=1696991576040" width={150} />
              </div>
            </div>
