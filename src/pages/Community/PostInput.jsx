        ...
        <form>
          <div className="w-full mb-4 border border-gray-200 rounded-lg">
            <div className="px-4 py-2 bg-transparent rounded-t-lg">
              ...
              <textarea id="comment" rows="4" className="w-full px-0 text-sm text-gray-900 bg-transparent border-0 focus:ring-0 " placeholder="Ceritakan kontribusimu terhadap lingkungan" required></textarea>
            </div>
            ...
            <div className="flex items-center justify-between  border-t dark:border-gray-600">
              <button type="submit" className="inline-flex items-center py-2.5 px-4 text-xs font-medium text-center text-white bg-green-400 rounded-lg focus:ring-4 focus:ring-blue-200 hover:bg-green-500">
                Post
              </button>
