...
const ProfilePost = () => {
  ...
  const { postsById, posts, loading, handleLike, handleDislike, button, setPostId, handleDeletePost } = useContext(PostContext);
  console.log('🚀 ~ file: ProfilePost.jsx:15 ~ ProfilePost ~ posts:', posts);
  console.log('🚀 ~ file: ProfilePost.jsx:15 ~ ProfilePost ~ postsById:', postsById);
